'''
Usage: python data_conversion_udacity_all.py --output_path output_file_name.record
'''
...
def create_tf_example(example):
    ...
    # Udacity all data set
    height = 0 # 1096 # Image height
    width = 0 # 1368 # Image width

    with Image.open(example['filename']) as img:
...
def main(_):
    ...
    INPUT_YAML = "data/all_training_data/all_data_annotations.yaml"
